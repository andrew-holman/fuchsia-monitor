...
const resourceMonServerURL = 'fuchsia-pkg://fuchsia.com/resource-monitor#meta/fuchsia_monitor_backend_cpp.cmx'
...
Future<void> _run() async {
  ...
  final resposne = await resourceMonServer.MonitorTime(1);
